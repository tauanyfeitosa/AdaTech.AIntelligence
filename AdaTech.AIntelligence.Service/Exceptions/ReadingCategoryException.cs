...
{
    /// <summary>
    /// Represents an exception thrown when reading a category encounters an error.
    /// </summary>
    public class ReadingCategoryException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadingCategoryException"/> class.
        /// </summary>
        public ReadingCategoryException() : base() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ReadingCategoryException"/> class with a specified error message.
        /// </summary>
